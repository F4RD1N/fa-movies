...
const OtherMethods = () => {
  const { signInUserWithGoogle, signInUserWithGithub, signInUserWithYahoo } =
    useAuthContext();

  return (
    <div className="flex justify-center mt-4">
      <ul className="flex justify-center space-x-2 items-center w-10/12">
